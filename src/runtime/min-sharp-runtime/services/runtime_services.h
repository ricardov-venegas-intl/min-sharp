...
typedef function_call_result(*type_initializer)(min_sharp_object* new_object, void *initializer_data);
...
typedef struct runtime_services_struct
{
	...
	// managed memory
	function_call_result(*push_scope)(runtime_services* this_instance, unsigned_int_16 number_of_elements, min_sharp_object* scope_variables[]);
	function_call_result(*pop_scope)(runtime_services* this_instance);
	function_call_result(*allocate_object)(runtime_services* this_instance, min_sharp_object** new_object, unsigned_int_16 internal_data_size);
	function_call_result(*collect_garbage)(runtime_services* this_instance);
	...
	// Primitives
	function_call_result (*build_number)(runtime_services* this_instance, min_sharp_object** returned_exception, min_sharp_object** returned_result);


	// Initialization
	function_call_result(*register_number_initializer)(runtime_services* this_instance, int number_object_size, type_initializer number_initializer, void* number_initializer_data);
